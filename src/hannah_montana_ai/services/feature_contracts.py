...
FINANCIAL_TRANSLATION_GLOSSARY = (
    ...
    ("강세", "strength", "sentiment", ()),
    ("약세", "weakness", "sentiment", ()),
    ("순매수", "net buying", "flow", ()),
    ("순매도", "net selling", "flow", ()),
    ("장중", "intraday", "market_state", ()),
    ("마감", "close", "market_state", ()),
    ("개장", "open", "market_state", ()),
    ("증가", "increase", "sentiment", ()),
    ("감소", "decrease", "sentiment", ()),
    ("상승", "rise", "sentiment", ()),
    ("하락", "decline", "sentiment", ()),
