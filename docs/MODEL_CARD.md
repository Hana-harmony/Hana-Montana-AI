...
| 한국 금융 용어 해설 | seed dictionary + Qwen3-0.6B LoRA RAG + web search fallback | `POST /api/v1/korean-financial-terms/explain` | [korean-financial-term-explainer.md](models/korean-financial-term-explainer.md) |
| 뉴스·공시 요약 Qwen3 LLM | rule engine fallback + optional Qwen3-0.6B LoRA | `POST /api/v1/alerts/analyze`, `POST /api/v1/intelligence/events` | [news-summary-llm-readiness.md](models/news-summary-llm-readiness.md) |
| 한국어 전문 번역 Qwen3 LLM | optional Qwen3-0.6B LoRA + strict translation gate | `POST /api/v1/translation/ko-en` | [korean-translation-qwen3.md](models/korean-translation-qwen3.md) |
