...
| 글로벌 피어 매칭 | KIS 활성 일반주식 전체 + TF-IDF/SVD/재무/업종/인지도 동적 유사도 + grounded template | `POST /api/v1/market/global-peers/match` | [global-peer-matcher.md](models/global-peer-matcher.md) |
