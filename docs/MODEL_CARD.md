...
| 글로벌 피어 매칭 | bounded TF-IDF/SVD + pairwise LogisticRegression + profile quality/MMR + grounded template | `POST /api/v1/market/global-peers/match` | [global-peer-matcher.md](models/global-peer-matcher.md) |
