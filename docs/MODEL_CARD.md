...
| 뉴스·공시 요약 LLM readiness | rule engine + optional Qwen3 sidecar 후보 | `POST /api/v1/alerts/analyze`, `POST /api/v1/intelligence/events` | [news-summary-llm-readiness.md](models/news-summary-llm-readiness.md) |
