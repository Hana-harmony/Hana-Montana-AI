...
| --- | --- | --- | --- |
| 뉴스·공시 분석 | KF-DeBERTa LoRA 금융 감성 + K-FNSPID 시장영향 + `financial_nlp_ml`, stock linker, 규칙 기반 What/Why/Impact | `POST /api/v1/alerts/analyze`, `/api/v1/intelligence/events` | [뉴스·공시 분석](docs/models/financial-alert-analysis.md), [K-FNSPID](docs/models/k-fnspid-market-impact.md), [도입 전후·연구 준비도](docs/models/k-fnspid-research-readiness.md) |
